...
export default function AiToolsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Direct link to Woningbeschrijving if available */}
      {tools.some(t => t.slug === 'woningbeschrijving') && (
        <div className="mt-8 glass-card border border-brand-orange/30 bg-brand-orange/5 p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="text-white font-semibold mb-1">Woningbeschrijving Generator</h4>
              ...
              <Link
                href="/dashboard/woningbeschrijving"
